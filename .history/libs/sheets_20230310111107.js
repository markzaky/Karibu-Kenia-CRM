...
export async function getHotels() {
  ...
  await doc.loadInfo();
  const AA_Lodge_Amboseli = doc.sheetsByTitle['AA_Lodge_Amboseli'];
  const AA_Lodge_Amboseli1 = doc.sheetsByTitle['AA_Lodge_Amboseli1'];
  ...
  //   }
  // else{
    return [AA_Lodge_Amboseli,AA_Lodge_Amboseli1];
  // }
